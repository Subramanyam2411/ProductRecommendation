...
from ProductRecommendation import views as mainView
...
urlpatterns = [
    ...
    path('product_recommendation/', admins.product_recommendation, name='product_recommendation'),
    ...
    path("data_preprocess/", usr.data_preprocess, name="data_preprocess"),
